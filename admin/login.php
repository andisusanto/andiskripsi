...
<body>
    <div id="login-wrapper" class="clearfix">
        <div class="main-col">
            ...
            <div class="panel">
                <p class="heading_main">Login</p>
                <form id="login-validate" action="processlogin.php" method="post">
                    <label for="login_name">Login</label>
                    <input type="text" id="login_name" name="txtUserName" placeholder="Username" />
                    <label for="login_password">Password</label>
                    <input type="password" id="login_password" name="txtPassword" placeholder="Password" />
